...
export default function Login() {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(`Your OTP: ${data.otp} (dev mode)`);
      } else {
        toast.error(data.error || "Phone not found");
      }
    } catch (err) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          <h1 style={{ fontSize: '28px', fontWeight: 'bold', color: '#1a1a2e', marginBottom: '5px' }}>
            Kinoo YSC
          </h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div>
            ...
            <input
              ...
              onFocus={(e) => e.target.style.border = '1px solid #0f3460'}
