                ...
                {messages.map((m: any) => {
                  ...
                  return (
                    <div key={m._id} style={{ display: "flex", justifyContent: isMine ? "flex-end" : "flex-start", marginBottom: "6px" }}>
                      <div style={{ maxWidth: isMobile ? "85%" : "65%", background: isMine ? "#dcf8c6" : (darkMode ? "#334155" : "white"), color: isMine ? "#000" : textColor, padding: "8px 12px", borderRadius: isMine ? "12px 12px 2px 12px" : "12px 12px 12px 2px", boxShadow: "0 1px 1px rgba(0,0,0,0.08)" }}>
